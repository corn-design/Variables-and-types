public class  SliceoHeaven{
    ...
    public void SliceOHeaven(String orderID, String pizzaIngredients, double orderTotal) {
    ...
    private void printReceipt(){
        ...
        public void processCardPayment(String cardName,String expiryDate,int cvv){
            
                String cardNumber = "1234567890";
                double price = 10.0;
                String blacklistedNumber = "9876543210";
